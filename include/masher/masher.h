#pragma once
...
#if defined(_WIN32)
    #define MASHER_LIB_EXPORT __declspec(dllexport)
    ...
    #define MASHER_LIB_EXPORT __attribute__ ((visibility("default")))
...
MASHER_LIB_EXPORT Error GetLoaderError(bool wipeLastError = true)
{
